...
from networksecurity.constant.training_pipeline import DATA_TRANSFORMATION_IMPUTER_PARAMETERS
...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            save_object(self.data_transformation_config.tranformed_object_file_path, preprocessor_object)

            save_object("final_model/preprocessor.pkl", preprocessor_object)

            # Preparing artifacts
            data_transformation_artifact = DataTransformationArtifact(transformed_object_file_path = self.data_transformation_config.tranformed_object_file_path,
